...
fn test_markup_export_auto_ms() {
    ...
    |:---|---:|---:|---:|---:|
    | `sleep 0.1` | 105.7 Â± 1.6 | 102.3 | 108.0 | 1.00 |
    | `sleep 2` | 2005.0 Â± 2.0 | 2002.0 | 2008.0 | 18.97 Â± 0.29 |
    "#);
...
fn test_markup_export_auto_s() {
    ...
    |:---|---:|---:|---:|---:|
    | `sleep 2` | 2.005 Â± 0.002 | 2.002 | 2.008 | 18.97 Â± 0.29 |
    | `sleep 0.1` | 0.106 Â± 0.002 | 0.102 | 0.108 | 1.00 |
    "#);
