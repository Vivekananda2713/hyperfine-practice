...
[ä¸­æ](https://github.com/chinanf-boy/hyperfine-zh)
...
|:---|---:|---:|---:|---:|
| `find . -iregex '.*[0-9]\.jpg$'` | 2.275 Â± 0.046 | 2.243 | 2.397 | 9.79 Â± 0.22 |
| `find . -iname '*[0-9].jpg'` | 1.427 Â± 0.026 | 1.405 | 1.468 | 6.14 Â± 0.13 |
| `fd -HI '.*[0-9]\.jpg$'` | 0.232 Â± 0.002 | 0.230 | 0.236 | 1.00 |
