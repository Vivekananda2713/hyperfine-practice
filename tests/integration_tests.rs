...
fn returns_mean_time_in_correct_unit() {
    hyperfine_debug()
        ...
        .assert()
        .success()
        .stdout(predicate::str::contains("Time (mean Â± Ï):      1.234 s Â±"));

    hyperfine_debug()
        .arg("sleep 0.123")
        .assert()
        .success()
        .stdout(predicate::str::contains("Time (mean Â± Ï):     123.0 ms Â±"));
    ...
    hyperfine_debug()
        ...
        .assert()
        .success()
        .stdout(predicate::str::contains("Time (mean Â± Ï):     1234.0 ms Â±"));
...
fn shows_benchmark_comparison_with_relative_times() {
    hyperfine_debug()
        ...
        .success()
        .stdout(
            predicate::str::contains("2.00 Â± 0.00 times faster")
                .and(predicate::str::contains("3.00 Â± 0.00 times faster")),
        );
}
...
fn shows_benchmark_comparison_with_same_time() {
    hyperfine_debug()
        ...
        .success()
        .stdout(
            predicate::str::contains("As fast (1.00 Â± 0.00) as")
                .and(predicate::str::contains("2.00 Â± 0.00 times faster"))
                .and(predicate::str::contains("1000.00 Â± 0.00 times faster")),
        );
}
...
fn shows_benchmark_comparison_relative_to_reference() {
    hyperfine_debug()
        ...
        .success()
        .stdout(
            predicate::str::contains("2.00 Â± 0.00 times slower")
                .and(predicate::str::contains("1.50 Â± 0.00 times faster")),
        );
}
...
fn speed_comparison_sort_order() {
    for sort_order in ["auto", "mean-time"] {
        hyperfine_debug()
            ...
            .success()
            .stdout(predicate::str::contains(
                "sleep 1 ran\n    2.00 Â± 0.00 times faster than sleep 2",
            ));
    }
